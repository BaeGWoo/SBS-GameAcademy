namespace Class6th__Function_
{
    internal class Program
    {
        ...
        {
            //기본 매개 변수를 사용할 때 왼쪽에서부터 기본 매개변수를 설정해주어야 합니다.
        ...
        static void Main(string[] args)
        {
            ...
            #region 기본 매개 변수
            //Position();
            //기본 매개 변수는 값을 넣을 때 왼쪽에 있는 매개 변수부터 값이 들어갑니다.
            #endregion

            //인수의 경우 함수에 있는 매개변수의 수에 따라 전달할 수 있는
            //인수의 수가 결정되며, 값을 전달하는 인수와
            //값을 전달받는 매개변수의 자료형이 서로 일치해야 합니다. 
            #endregion
            ...
            //계속 쌓이게 되므로 스택 오버플로우가 일어나게 됩니다.

            #endregion

            #region 박싱과 언박싱
            //박싱은 값 형식을 참조 형식으로 변환하는 과정을 의미하며,
            //언박싱은 참조형식을 값 형식으로 변환하는 과정입니다.
